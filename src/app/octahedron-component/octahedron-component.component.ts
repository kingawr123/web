...
@Component({
  ...
  templateUrl: './octahedron-component.component.html',
  styleUrls: ['./octahedron-component.component.scss']
})
export class OctahedronComponentComponent implements OnInit {
